...
annots = os.path.join(sys.argv[1],f"v{params['count']}",'annotations')

outputannot = os.path.join(sys.argv[2],f"v{params['count']}")
...
df.to_pickle(os.path.join(outputannot,'v{}.pkl'.format(params['count'])))